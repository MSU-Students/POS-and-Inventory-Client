...
export const DefaultApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    mediaControllerDownloadFile: async (
      id: number,
      options: any = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
...
export const DefaultApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async mediaControllerDownloadFile(
      id: number,
      options?: any
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.mediaControllerDownloadFile(
          id,
          options
        );
      return createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.mediaControllerUpload(file, options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
...
export const DefaultApiFactory = function (
  ...
  return {
    ...
    mediaControllerDownloadFile(id: number, options?: any): AxiosPromise<void> {
      return localVarFp
        .mediaControllerDownloadFile(id, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    mediaControllerUpload(file?: any, options?: any): AxiosPromise<MediaDto> {
      return localVarFp
        .mediaControllerUpload(file, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
...
export class DefaultApi extends BaseAPI {
   ...
   * @memberof DefaultApi
   */
  public mediaControllerDownloadFile(id: number, options?: any) {
    return DefaultApiFp(this.configuration)
      .mediaControllerDownloadFile(id, options)
      .then((request) => request(this.axios, this.basePath));
  }
   ...
   * @memberof DefaultApi
   */
  public mediaControllerUpload(file?: any, options?: any) {
    return DefaultApiFp(this.configuration)
      .mediaControllerUpload(file, options)
      .then((request) => request(this.axios, this.basePath));
  }
